...
def processSingleQuery(imagefile, rindex, mode="N_GRAM"):
    ...
    if mode == "NORMAL":
        ...
        offsetDict = getOffsetDeltaDynamicStaticN_GRAM(bscore_query, rindices=rindex, Max_N=4)                                                      Max_N=4)
...
imagefile = "20210805_235752.jpg"
input("Press enter to continue:")
pieceScores, histograms = processSingleQuery(imagefile, rindex, counts, "Dynamic_Static")
for i in range(10):
    print(pieceScores[i])
